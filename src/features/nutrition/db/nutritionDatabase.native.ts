...
const FALLBACK_PORTIONS = [
  { id: 'portion-1', food_id: 'usda_foundation:534358', amount: 1, unit: 'bowl', modifier: null, gram_weight: 340, label: '1 bowl (340 g)', is_default: 0 },
  { id: 'portion-2', food_id: 'usda_sr_legacy:173944', amount: 1, unit: 'cup', modifier: 'cooked', gram_weight: 234, label: '1 cup cooked (234 g)', is_default: 0 },
  { id: 'portion-3', food_id: 'usda_sr_legacy:43566', amount: 1, unit: 'banana', modifier: 'medium', gram_weight: 118, label: '1 medium banana (118 g)', is_default: 0 },
  { id: 'portion-4', food_id: 'usda_foundation:746782', amount: 1, unit: 'scoop', modifier: null, gram_weight: 35, label: '1 scoop (35 g)', is_default: 1 },
] as const;
...
async function initializeNutritionDatabaseAsync(): Promise<SQLiteDatabase | null> {
