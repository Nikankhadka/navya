...
export const MOCK_MEAL_TEMPLATES = [
  {
    id: 'template-1',
    ...
    foods: [
      {
        meal_name: 'Scrambled Eggs (2 large)',
        calories: 182,
        protein_g: 12,
        carbs_g: 2,
        fat_g: 14,
      ...
      {
        meal_name: 'Wholegrain Toast (2 slices)',
        calories: 176,
        protein_g: 6,
        carbs_g: 32,
        fat_g: 3,
  ...
  },
  {
    ...
    foods: [
      {
        meal_name: 'Grilled Chicken Breast (150g)',
        calories: 248,
        protein_g: 46,
        carbs_g: 0,
        fat_g: 5,
