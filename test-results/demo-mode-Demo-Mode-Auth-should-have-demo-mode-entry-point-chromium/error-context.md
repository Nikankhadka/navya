...
- Name: demo-mode.spec.ts >> Demo Mode & Auth >> should have demo mode entry point
- Location: e2e/demo-mode.spec.ts:17:7
...
Locator: getByRole('button', { name: 'Explore Demo App' })
Expected: visible
Timeout: 5000ms
...
Call log:
  ...
  - waiting for getByRole('button', { name: 'Explore Demo App' })
