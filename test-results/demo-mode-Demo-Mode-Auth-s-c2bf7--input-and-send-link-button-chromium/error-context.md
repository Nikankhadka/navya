...
- Name: demo-mode.spec.ts >> Demo Mode & Auth >> should have email input and send link button
- Location: e2e/demo-mode.spec.ts:11:7
...
Locator: getByRole('button', { name: 'Send Email Link' })
Expected: visible
Timeout: 5000ms
...
Call log:
  ...
  - waiting for getByRole('button', { name: 'Send Email Link' })
